...
export declare class L2Block {
     ...
     * The L1 to L2 messages to be inserted into the L2 toL2 message tree.
     */
    newL1ToL2Messages?: Fr[], newEncryptedLogs?: L2BlockL2Logs, newUnencryptedLogs?: L2BlockL2Logs, blockHash?: Buffer | undefined);
    /**
     ...
     */
    static random(l2BlockNum: number, txsPerBlock?: number, numPrivateFunctionCalls?: number, numPublicFunctionCalls?: number, numEncryptedLogs?: number, numUnencryptedLogs?: number): L2Block;
    /**
     ...
     */
    static decode(encoded: Buffer | BufferReader): L2Block;
    /**
