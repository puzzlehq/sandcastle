...
export declare const SchnorrAccountContractAbi: ContractAbi;
/**
...
export declare class SchnorrAccountContract extends ContractBase {
    ...
    /** The wallet. */
    wallet: Wallet): Promise<SchnorrAccountContract>;
    /**
     * Creates a tx to deploy a new instance of this contract.
     */
    static deploy(rpc: AztecRPC, signing_pub_key_x: FieldLike, signing_pub_key_y: FieldLike): DeployMethod<SchnorrAccountContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified public key to derive the address.
     */
    static deployWithPublicKey(rpc: AztecRPC, publicKey: PublicKey, signing_pub_key_x: FieldLike, signing_pub_key_y: FieldLike): DeployMethod<SchnorrAccountContract>;
    /**
...
//# sourceMappingURL=schnorr_account.d.ts.map