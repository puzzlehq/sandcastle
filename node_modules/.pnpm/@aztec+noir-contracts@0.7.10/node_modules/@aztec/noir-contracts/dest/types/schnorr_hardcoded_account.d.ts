...
export declare const SchnorrHardcodedAccountContractAbi: ContractAbi;
/**
...
export declare class SchnorrHardcodedAccountContract extends ContractBase {
    ...
    /** The wallet. */
    wallet: Wallet): Promise<SchnorrHardcodedAccountContract>;
    /**
     * Creates a tx to deploy a new instance of this contract.
     */
    static deploy(rpc: AztecRPC): DeployMethod<SchnorrHardcodedAccountContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified public key to derive the address.
     */
    static deployWithPublicKey(rpc: AztecRPC, publicKey: PublicKey): DeployMethod<SchnorrHardcodedAccountContract>;
    /**
...
//# sourceMappingURL=schnorr_hardcoded_account.d.ts.map