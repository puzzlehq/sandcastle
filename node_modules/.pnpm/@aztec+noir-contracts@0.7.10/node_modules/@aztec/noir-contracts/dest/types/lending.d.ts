...
export declare const LendingContractAbi: ContractAbi;
/**
...
export declare class LendingContract extends ContractBase {
    ...
    /** The wallet. */
    wallet: Wallet): Promise<LendingContract>;
    /**
     * Creates a tx to deploy a new instance of this contract.
     */
    static deploy(rpc: AztecRPC): DeployMethod<LendingContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified public key to derive the address.
     */
    static deployWithPublicKey(rpc: AztecRPC, publicKey: PublicKey): DeployMethod<LendingContract>;
    /**
