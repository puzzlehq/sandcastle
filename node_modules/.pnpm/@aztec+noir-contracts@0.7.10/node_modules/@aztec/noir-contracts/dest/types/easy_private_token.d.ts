...
export declare const EasyPrivateTokenContractAbi: ContractAbi;
/**
...
export declare class EasyPrivateTokenContract extends ContractBase {
    ...
    /** The wallet. */
    wallet: Wallet): Promise<EasyPrivateTokenContract>;
    /**
     * Creates a tx to deploy a new instance of this contract.
     */
    static deploy(rpc: AztecRPC, initial_supply: bigint | number, owner: FieldLike): DeployMethod<EasyPrivateTokenContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified public key to derive the address.
     */
    static deployWithPublicKey(rpc: AztecRPC, publicKey: PublicKey, initial_supply: bigint | number, owner: FieldLike): DeployMethod<EasyPrivateTokenContract>;
    /**
    ...
    methods: {
        ...
        mint: ((amount: bigint | number, owner: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** transfer(amount: integer, sender: field, recipient: field) */
        transfer: ((amount: bigint | number, sender: FieldLike, recipient: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    };
}
//# sourceMappingURL=easy_private_token.d.ts.map