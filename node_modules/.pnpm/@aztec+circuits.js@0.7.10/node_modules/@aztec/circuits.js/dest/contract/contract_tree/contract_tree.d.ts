...
import { CircuitsWasm, ContractFunctionDao, Fr, FunctionData } from '@aztec/circuits.js';
 ...
 */
export declare function hashVKStr(vk: string, wasm: CircuitsWasm): Buffer;
/**
 ...
 */
export declare function generateFunctionLeaves(functions: ContractFunctionDao[], wasm: CircuitsWasm): Fr[];
/**
