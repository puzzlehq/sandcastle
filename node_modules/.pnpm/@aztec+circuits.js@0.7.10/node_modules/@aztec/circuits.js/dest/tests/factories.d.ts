...
import { AggregationObject, AppendOnlyTreeSnapshot, BaseOrMergeRollupPublicInputs, BaseRollupInputs, CallContext, CombinedAccumulatedData, CombinedConstantData, ConstantRollupData, ContractDeploymentData, ContractStorageRead, ContractStorageUpdateRequest, FinalAccumulatedData, Fr, FunctionSelector, HistoricBlockData, KernelCircuitPublicInputs, MembershipWitness, MergeRollupInputs, NewContractData, OptionallyRevealedData, Point, PreviousKernelData, PreviousRollupData, PrivateCallData, PrivateCallStackItem, PrivateCircuitPublicInputs, PrivateKernelInputsInit, PrivateKernelInputsInner, PrivateKernelPublicInputsFinal, Proof, PublicCallData, PublicCallRequest, PublicCallStackItem, PublicCircuitPublicInputs, PublicDataRead, PublicDataUpdateRequest, PublicKernelInputs, ReadRequestMembershipWitness, RootRollupInputs, RootRollupPublicInputs, TxContext, TxRequest, VerificationKey, WitnessedPublicCallData } from '../index.js';
 ...
 */
export declare function makeHistoricBlockData(seed: number): HistoricBlockData;
/**
 ...
 */
export declare function makePublicCallData(seed?: number, full?: boolean): Promise<PublicCallData>;
/**
 ...
 */
export declare function makeWitnessedPublicCallData(seed?: number): Promise<WitnessedPublicCallData>;
/**
 ...
 */
export declare function makePublicKernelInputs(seed?: number): Promise<PublicKernelInputs>;
/**
 * Makes arbitrary public kernel inputs.
 * @param seed - The seed to use for generating the public kernel inputs.
 ...
 * @returns Public kernel inputs.
 */
export declare function makePublicKernelInputsWithTweak(seed?: number, tweak?: (publicKernelInputs: PublicKernelInputs) => void): Promise<PublicKernelInputs>;
/**
