...
import { MAX_PUBLIC_CALL_STACK_LENGTH_PER_CALL, PUBLIC_DATA_TREE_HEIGHT } from '../../cbind/constants.gen.js';
...
export declare class PublicCallData {
     ...
     */
    readonly publicCallStackPreimages: Tuple<PublicCallStackItem, typeof MAX_PUBLIC_CALL_STACK_LENGTH_PER_CALL>;
    /**
     ...
     * Children call stack items.
     */
    publicCallStackPreimages: Tuple<PublicCallStackItem, typeof MAX_PUBLIC_CALL_STACK_LENGTH_PER_CALL>, 
    /**
     * Proof of the call stack item execution.
     */
    proof: Proof, 
