...
import { HISTORIC_BLOCKS_TREE_HEIGHT, L1_TO_L2_MSG_SUBTREE_SIBLING_PATH_LENGTH, NUMBER_OF_L1_L2_MESSAGES_PER_ROLLUP } from '../../cbind/constants.gen.js';
...
export declare class RootRollupInputs {
     ...
     */
    newHistoricBlocksTreeSiblingPath: Tuple<Fr, typeof HISTORIC_BLOCKS_TREE_HEIGHT>;
    constructor(
    /**
     * The previous rollup data.
     * Note: Root rollup circuit is the latest circuit the chain of circuits and the previous rollup data is the data
...
export declare class RootRollupPublicInputs {
     ...
     */
    startTreeOfHistoricL1ToL2MessagesTreeRootsSnapshot: AppendOnlyTreeSnapshot;
    /**
     * Snapshot of the historic L1 to L2 message tree roots tree at the end of the rollup.
     */
    endTreeOfHistoricL1ToL2MessagesTreeRootsSnapshot: AppendOnlyTreeSnapshot;
    /**
     ...
     */
    l1ToL2MessagesHash: [Fr, Fr]);
    static getFields(fields: FieldsOf<RootRollupPublicInputs>): readonly [AggregationObject, GlobalVariables, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, Fr, Fr, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, [Fr, Fr], [Fr, Fr]];
    toBuffer(): Buffer;
