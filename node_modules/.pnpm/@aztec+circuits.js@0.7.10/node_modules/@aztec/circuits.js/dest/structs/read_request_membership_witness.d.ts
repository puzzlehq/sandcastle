...
export declare class ReadRequestMembershipWitness {
     ...
     */
    siblingPath: Tuple<Fr, typeof PRIVATE_DATA_TREE_HEIGHT>;
    /**
    ...
    static fromBufferArray(leafIndex: Fr, siblingPath: Tuple<Buffer, typeof PRIVATE_DATA_TREE_HEIGHT>, isTransient: boolean, hintToCommitment: Fr): ReadRequestMembershipWitness;
    static fromMembershipWitness(membershipWitness: MembershipWitness<typeof PRIVATE_DATA_TREE_HEIGHT>, isTransient: boolean, hintToCommitment: Fr): ReadRequestMembershipWitness;
    /**
