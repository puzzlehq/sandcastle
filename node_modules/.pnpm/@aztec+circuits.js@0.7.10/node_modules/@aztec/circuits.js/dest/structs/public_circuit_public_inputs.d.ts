...
export declare class PublicCircuitPublicInputs {
     ...
     */
    publicCallStack: Tuple<Fr, typeof MAX_PUBLIC_CALL_STACK_LENGTH_PER_CALL>;
    /**
     ...
     * @returns The array.
     */
    static getFields(fields: FieldsOf<PublicCircuitPublicInputs>): readonly [CallContext, Fr, [Fr, Fr, Fr, Fr], [ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest, ContractStorageUpdateRequest], [ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead, ContractStorageRead], [Fr, Fr, Fr, Fr], [Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr], [Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr], [Fr, Fr], [Fr, Fr], Fr, HistoricBlockData, AztecAddress];
    /**
