...
import { CircuitsWasm, VK_TREE_HEIGHT } from '../../index.js';
 ...
 */
export declare class PreviousKernelData {
    /**
 ...
 */
export declare class DummyPreviousKernelData {
    private data;
     ...
     */
    static getDummyPreviousKernelData(wasm: CircuitsWasm): PreviousKernelData;
    /**
     * Gets the the dummy data.
     * @returns The dummy previous kernel data.
     */
    getData(): PreviousKernelData;
}
//# sourceMappingURL=previous_kernel_data.d.ts.map