...
import { CONTRACT_TREE_HEIGHT, FUNCTION_TREE_HEIGHT, MAX_NEW_NULLIFIERS_PER_TX, MAX_PRIVATE_CALL_STACK_LENGTH_PER_CALL, MAX_READ_REQUESTS_PER_CALL, MAX_READ_REQUESTS_PER_TX } from '../../cbind/constants.gen.js';
...
export declare class PrivateCallData {
     ...
     * @returns The array.
     */
    static getFields(fields: FieldsOf<PrivateCallData>): readonly [PrivateCallStackItem, [PrivateCallStackItem, PrivateCallStackItem, PrivateCallStackItem, PrivateCallStackItem], Proof, VerificationKey, MembershipWitness<4>, MembershipWitness<16>, [ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness, ReadRequestMembershipWitness], Fr, Fr];
