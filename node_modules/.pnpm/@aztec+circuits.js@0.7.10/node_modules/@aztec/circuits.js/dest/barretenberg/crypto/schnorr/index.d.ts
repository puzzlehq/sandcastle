...
import { GrumpkinPrivateKey, PublicKey } from '../../../index.js';
...
export declare class Schnorr {
     ...
     */
    computePublicKey(privateKey: GrumpkinPrivateKey): PublicKey;
    /**
     ...
     */
    constructSignature(msg: Uint8Array, privateKey: GrumpkinPrivateKey): SchnorrSignature;
    /**
     ...
     */
    verifySignature(msg: Uint8Array, pubKey: PublicKey, sig: SchnorrSignature): boolean;
}
