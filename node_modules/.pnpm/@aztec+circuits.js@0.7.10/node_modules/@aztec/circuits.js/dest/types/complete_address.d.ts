...
import { Fr, GrumpkinPrivateKey } from '../index.js';
...
export declare class CompleteAddress {
    ...
    /** Partial key corresponding to the public key to the address. */
    partialAddress: PartialAddress);
    static create(address: AztecAddress, publicKey: PublicKey, partialAddress: PartialAddress): Promise<CompleteAddress>;
    static random(): Promise<CompleteAddress>;
    static fromPrivateKeyAndPartialAddress(privateKey: GrumpkinPrivateKey, partialAddress: Fr): Promise<CompleteAddress>;
    /**
